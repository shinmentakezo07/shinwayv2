...
<execution_context>
@/teamspace/studios/this_studio/dikders/.claude/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @/teamspace/studios/this_studio/dikders/.claude/get-shit-done/workflows/session-report.md end-to-end.
</process>
