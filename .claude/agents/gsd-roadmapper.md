...
Reference full template: `/teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/state.md`.
