...
Use template from `/teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/teamspace/studios/this_studio/dikders/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
