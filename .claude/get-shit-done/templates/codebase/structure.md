...
- Usage: Reference from command with `@/teamspace/studios/this_studio/dikders/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /teamspace/studios/this_studio/dikders/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /teamspace/studios/this_studio/dikders/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
