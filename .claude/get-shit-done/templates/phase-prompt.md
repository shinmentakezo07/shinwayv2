...
<!-- For checkpoint task examples and patterns, see @/teamspace/studios/this_studio/dikders/.claude/get-shit-done/references/checkpoints.md -->
...
See `/teamspace/studios/this_studio/dikders/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/teamspace/studios/this_studio/dikders/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
