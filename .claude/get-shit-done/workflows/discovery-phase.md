...
See /teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/discovery.md
...
Use /teamspace/studios/this_studio/dikders/.claude/get-shit-done/templates/discovery.md.
