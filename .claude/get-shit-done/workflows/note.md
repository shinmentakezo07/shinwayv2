...
- **Global scope**: `/teamspace/studios/this_studio/dikders/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/teamspace/studios/this_studio/dikders/.claude/notes/`)
...
2. Glob `/teamspace/studios/this_studio/dikders/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/teamspace/studios/this_studio/dikders/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/teamspace/studios/this_studio/dikders/.claude/notes/` — works in any directory
